...
parser.add_argument('--nEpochs', type=int, default=42, help='number of epochs to train for')
...
parser.add_argument('--img_flist', type=str, default='/home/lab265/lab265/liulu/edge_connect/datasets/celeba_train.flist')
parser.add_argument('--mask_flist', type=str, default='/home/lab265/lab265/liulu/edge_connect/datasets/masks.flist')
...
parser.add_argument('--test_mask_flist', type=str, default='./datasets/mask/train_mask6.flist')
parser.add_argument('--test_img_flist', type=str, default='./datasets/psv/psv_val.flist')
...
def train(epoch):
    ...
    for batch in training_data_loader:
        ...
        if iteration % opt.print_interval == 0:
            print(
                "=> Epoch[{}]({}/{}): Avg L1 loss: {:.6f} | G loss: {:.6f} | Avg D loss: {:.6f} || Timer: {:.4f} sec. "
                "| IO: {:.4f}".format(
                ...
                flush=True)
            # print("=> Epoch[{}]({}/{}): Avg G loss: {:.6f} || Timer: {:.4f} sec. || IO: {:.4f}".format( epoch,
            # iteration, len(training_data_loader), avg_g_loss/opt.print_interval, td, t_io2-t_io1), flush=True)
