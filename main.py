...
parser.add_argument('--img_flist', type=str, default='./datasets/CelebA_HQ_256/CelebA_HQ_256_train.flist')
parser.add_argument('--mask_flist', type=str, default='./datasets/mask/train_mask5.flist')
...
parser.add_argument('--prefix', default='celeba_hq_256_irr_0.5', help='Location to save checkpoint models')
